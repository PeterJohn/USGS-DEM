...
std::string const& DEMHeader::getQuadName() const
{
  return _quadName;
}

std::string const& DEMHeader::getProcessInfo() const
{
  return _processInfo;
}

double DEMHeader::getSEGeoCornerX() const
{
  return _seGeoCornerX;
}

double DEMHeader::getSEGeoCornerY() const
{
  return _seGeoCornerY;
}

long DEMHeader::getProcessCode() const
{
  return _processCode;
}

std::string const& DEMHeader::getSectionIndicator() const
{
  return _sectionIndicator;
}

std::string const& DEMHeader::getMappingCenterCode() const
{
  return _mapCenterCode;
}

long DEMHeader::getLevelCode() const
{
  return _levelCode;
}
         
long DEMHeader::getElevPattern() const
{
  return _elevPattern;
}

long DEMHeader::getGroundRefSysCode() const
{
  return _groundRefSysCode;
}
    
long DEMHeader::getGroundRefSysZone() const
{
  return _groundRefSysZone;
}

long DEMHeader::getGroundRefSysUnits() const
{
  return _groundRefSysUnits;
}

long DEMHeader::getElevationUnits() const
{
  return _elevUnits;
}

long DEMHeader::getNumPolySides() const
{
  return _numPolySides;
}

DEMPointVector const& DEMHeader::getDEMCorners() const
{
  return _demCorners;
}

double DEMHeader::getCounterclockAngle() const
{
  return _counterclockAngle;
}

long DEMHeader::getElevAccuracyCode() const
{
  return _elevAccuracyCode;
}

double DEMHeader::getMinimumElev() const
{
  return _minElevation;
}

double DEMHeader::getMaximumElev() const
{
  return _maxElevation;
}

double DEMHeader::getSpatialResX() const
{
  return _spatialResX;
}

double DEMHeader::getSpatialResY() const
{
  return _spatialResY;
}

double DEMHeader::getSpatialResZ() const
{
  return _spatialResZ;
}

long DEMHeader::getProfileRows() const
{
  return _profileRows;
}

long DEMHeader::getProfileColumns() const
{
  return _profileColumns;
}

long DEMHeader::getLargeContInt() const
{
  return _largeContInt;
}

long DEMHeader::getMaxSourceUnits() const
{
  return _maxSourceUnits;
}

long DEMHeader::getSmallContInt() const
{
  return _smallContInt;
}

long DEMHeader::getMinSourceUnits() const
{
  return _minSourceUnits;
}

long DEMHeader::getSourceDate() const
{
  return _sourceDate;
}

long DEMHeader::getInspRevDate() const
{
  return _inspRevDate;
}

std::string const& DEMHeader::getInspFlag() const
{
  return _inspFlag;
}

long DEMHeader::getDataValFlag() const
{
  return _valFlag;
}

long DEMHeader::getSuspectVoidFlag() const
{
  return _suspectVoidFlg;
}

long DEMHeader::getVertDatum () const
{
  return _vertDatum;
}

long DEMHeader::getHorizDatum() const
{
  return _horizDatum;
}

long DEMHeader::getDataEdition() const
{
  return _dataEdition;
}

long DEMHeader::getPerctVoid() const
{
  return _perctVoid;
}

long DEMHeader::getWestEdgeFlag() const
{
  return _westEdgeFlag;
}

long DEMHeader::getNorthEdgeFlag() const
{
  return _northEdgeFlag;
}

long DEMHeader::getEastEdgeFlag() const
{
  return _eastEdgeFlag;
}

long DEMHeader::getSouthEdgeFlag() const
{
  return _southEdgeFlag;
}

double DEMHeader::getVertDatumShift() const
{
  return _vertDatumShift;
}

std::ostream& operator<<(std::ostream& s, DEMHeader& header)
{
  return s;
}

std::istream& operator>>(std::istream& s, DEMHeader& header)
{
  char bufstr[1024];
  char temp[1024];
  long i;
