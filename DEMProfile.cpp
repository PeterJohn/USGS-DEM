...
DEMProfile const& DEMProfile::operator=(DEMProfile const& right)
{
  if (this == &right)
    return *this;
...
long DEMProfile::getRowNumber() const
{
  return _row;
}

long DEMProfile::getColumnNumber() const
{
  return _column;
}

long DEMProfile::getNumberOfElevations() const
{
  return _numberElevations;
}

DEMPoint const& DEMProfile::getProfileLocation() const
{
  return _profileLocation;
}

double DEMProfile::getLocalDatumElevation() const
{
  return _locDatumElev;
}

double DEMProfile::getMinimumElev() const
{
  return _minElev;
}

double DEMProfile::getMaximumElev() const
{
  return _maxElev;
}

DEMElevationVector const& DEMProfile::getElevations() const
{
  return _elevations;
}

std::istream& operator>>(std::istream& s, DEMProfile& demp)
{
  char bufstr[1024];
...
std::ostream& operator<<(std::ostream& s, DEMProfile& demp)
{
  return s;
}
