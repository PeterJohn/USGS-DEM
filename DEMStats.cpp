...
long DEMStats::getAvailCodeDE2() const
{
  return _availCodeDE2;
}

long DEMStats::getRSMEDE2x() const
{
  return _rsmeDE2x;
}

long DEMStats::getRSMEDE2y() const
{
  return _rsmeDE2y;
}

long DEMStats::getRSMEDE2z() const
{
  return _rsmeDE2z;
}

long DEMStats::getSampleSizeDE2() const
{
  return _sampleSizeDE2;
}

long DEMStats::getAvailCodeDE5() const
{
  return _availCodeDE5;
}

long DEMStats::getRSMEDE5x() const
{
  return _rsmeDE5x;
}

long DEMStats::getRSMEDE5y() const
{
  return _rsmeDE5y;
}

long DEMStats::getRSMEDE5z() const
{
  return _rsmeDE5z;
}

long DEMStats::getSampleSizeDE5() const
{
  return _sampleSizeDE5;
}

std::ostream& operator<<(std::ostream& s,  DEMStats const& stats)
{
  return s;
}

std::istream& operator>>(std::istream& s, DEMStats& stats)
{
  char bufstr[1024];
