...
class DEMHeader
{
 public:
  ...
  DEMHeader();
  friend std::ostream& operator<<(std::ostream& s, DEMHeader& header);
  friend std::istream& operator>>(std::istream& s, DEMHeader& header);
  ...
  // Vertical datum shift - value is in the form of SFFF.DD Value is the 
  // average
